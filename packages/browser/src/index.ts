 ...
 * presets the transport to Vigilly's ingest (via the SDK's `tunnel` option) and
 * exposes only the exception-reporting surface Vigilly supports today.
 *
 ...
 * envelopes to `https://<project>.vigilly.dev/api/observe/<projectId>/envelope/`.
 */
